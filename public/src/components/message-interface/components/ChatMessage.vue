<template>
  <div class="flex" :class="{lateral: props.lateral}">
          ...
          <template v-for="(block, index) in message.blocks" v-bind:key="block">
            ...
            <template v-else>
              ...
              <component
                ...
                class="message-content"
                :class="{
                  ...block.data.contentClass,
                  action: block.data.isAction,
                }"
...
.lateral .message-container.assistant {
  transform: translateX(-13ch);
}

.lateral .message-container.user {
  transform: translateX(13ch);
}
