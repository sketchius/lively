      ...
      <div class="layout">
        ...
        <form>
          <div class="field-grid">
            <label class="horizontal" for="title">TYPE</label><div class="field type">{{ type }}</div>
            <label class="horizontal" for="title">TITLE</label><div class="field">{{ title }}</div>
            <label class="horizontal" for="title">DETAILS</label><div class="field">{{ details }}</div>
            <label class="horizontal" for="title">PRIORITY</label><div class="field">{{ priority }}</div>
            <label class="horizontal" for="title">TIMEFRAME</label><div class="field">{{ timeframe }}</div>
          </div>
          <div class="buttons">
